...
8. 【真题部分（D级与板块12）】：所有真题/改编题必须给出完整分步解析与最终答案。硬性红线：禁止出现“证明略”“易证”“显然”“同理”“过程略”“解答略”“步骤略”等省略性表述，每道题都要完整写出过程。
...
【板块细化要求】必背公式按类全量罗列至少10条（每条含名称/公式/适用条件），必须覆盖本专题全部求通项与求和的方法（如累加/累乘/构造/取倒数/错位相减/裂项/倒序相加/分组/并项），一个都不能少；基本性质分专题至少8条（每条含表述+用法）；题型板块内部按“方法总览→各方法要点+按难度例题”组织，B级核心方法必须覆盖本专题全部核心方法、每个方法至少1道例题；题型识别写成“看到【特征】→【方法】”并按求通项/求和/证明/综合分类至少12条；易错点每条用【易错点】【典型错误】【正确做法】三段式至少6条；重难点只聚焦2~3个核心方法（适用类型→标准步骤→完整例题→卡点提醒）。【硬性红线】禁止出现“证明略”“易证”“显然”“同理”“过程略”“解答略”“步骤略”等省略性表述，任何题目都要完整写出过程与答案。
